...
userItemMatrix = scipy.io.mmread("../../fully_proessed_data/processed_data_zygote/whole_matrix_ip2matlab_zygote")
...
scipy.io.savemat("zygote_" + str(masking_precentage*100) + ".mat", mdict = {"arr" : userItemMatrix})
learning_rate = 1e-3
hidden_layer = 4000
lambda_val = 2000
...
print("<------------------------------------Statistics for zygote dataset------------------------------------>")
