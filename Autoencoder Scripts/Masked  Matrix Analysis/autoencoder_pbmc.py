...
userItemMatrix = np.loadtxt(open("../../fully_proessed_data/processed_data_pbmc/68kdata/whole_matrix.csv", "rb"), delimiter=",", skiprows=1)
...
scipy.io.savemat("pbmc_" + str(masking_precentage*100) + ".mat", mdict = {"arr" : userItemMatrix}) 
...
print("<------------------------------------Statistics for pbmc dataset------------------------------------>")
